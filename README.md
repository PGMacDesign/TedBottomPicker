...
//implementation ('com.github.PGMacDesign:TedRxOnActivityResult:1.1.0')
//Note, using the older one for now
implementation ('gun0912.ted:tedonactivityresult:1.0.6')
```

(Note that this library requires the `TedRxOnActivityResult` in order to use the gallery + camera options)
